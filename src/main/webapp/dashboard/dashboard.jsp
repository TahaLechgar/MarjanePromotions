...
<section class="dashboard w-full h-screen overflow-scroll flex bg-sky-50" >
    <div class="side-bare w-2/12 h-auto mt-24 mb-4 ml-4 rounded-2xl bg-white flex flex-col justify-center items-end gap-10 ">

        <a href="#" class="link w-10/12 h-16 flex justify-start align-center rounded-l-2xl pr-4 lg:pr-8 bg-sky-50">
        ...
        <c:out value="${departmentManagers.get(0).getEmail()}" />

...
<%--    </div>--%>
    <div class="flex flex-col max-h-6/12 w-11/12 my-10 mx-auto">
        ...
        <div class="my-4 flex flex-row justify-between">
            ...
            <button class="flex flex-row items-center py-2 px-4 text-white rounded-md" style="background-color: #005EB1">
...
<%--<div class=" h-6/12 overflow-scroll w-full mt-10 sm:mt-0">--%>
